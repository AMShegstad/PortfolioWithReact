export const data = [{
    ...
    },
    {
        ...
        'description': 'This software provideds 5 days worth of weather data for the city of the user\'s choosing. It gives the date, an icon representing the expected weather conditions, the temperature, wind speed, and humidity levels for each given day. A history of searches is maintained, and buttons are provided on the left-hand side of the screen, allowing the user quick access to refresh the weather data for those cities. The backend relies on HTTP calls using Express routing.',
    ...
    },
    {
        ...
        'description': 'Vehicle Builder is software that utilizes the command line interface to retrive input from the user to operate and perform certain functions of the selected vehicle. The user can choose from an array of preselected vehicles, or create and add their own. Vehicle types include Cars, Trucks, and Motorbikes, with classes in place for each. Trucks and Motorcycles also contain methods that are unique to their respective classes.',
    ...
    },
    {
        ...
        'description': 'Working through all relevant exercises in the textbook "Introduction to Java Programming and Data Structures" by Y Daniel Liang. I didn\'t work through all of these tasks when I was studying the textbook in school, but I thought it\'d be good practice to work through the entire collection of exercises. The goal is to complete the entire textbook before Summer of 2025, at which point I intend to become intimately acquainted with Spring Boot and more Java frameworks. Wish me luck!',
